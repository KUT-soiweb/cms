<div class="section" id="userSection">
    <div class="row">
        ...
        <div class="col-md-8">
            <a class="ml-2 float-right btn btn-primary" href="">編集</a>
            <?php
            // 管理者のみ表示
            ...
            <table class="table table-bordered mt-2">
                ...
                <tbody>
                    ...
                    foreach ($users as $userObj) {
                        $userParams = $userObj->as_array();
                    ?>
                        <tr>
                            <td class="text-truncate"><?= $userParams['user_id']; ?></td>
                            <td class="text-truncate"><?= $userParams['name']; ?></td>
                            <td class="text-truncate"><?= $userObj->roles()->find_one()->role_name; ?></td>
                            <td><a class="btn btn-primary d-block" href="">編集</a></td>
